 ...
 * @details Implementa Comparator per ordinare alfabeticamente gli utenti in base a cognome e nome.
...
public class ComparatoreCognomeNomeUtente implements Comparator<Utente>{
     ...
     * @return Valore negativo, zero o positivo secondo l'ordine alfabetico prima del cognome e poi del nome.
     */
    @Override
    public int compare(Utente u1, Utente u2) {
        
        if(u1.getCognome().equals(u2.getCognome())) return u1.getNome().compareTo(u2.getNome());
